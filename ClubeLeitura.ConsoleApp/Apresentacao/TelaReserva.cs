...
public class TelaReserva : ITela
{
    ...
    public TelaReserva(RepositorioRevista repositorioRevista, RepositorioReserva repositorioReserva, RepositorioAmigo repositorioAmigo)
    {
    ...
    public string? ObterOpcaoMenu()
    {
        ...
        Console.WriteLine("---------------------------------");
        Console.WriteLine("1 - Abrir Reserva");
    ...
    public void Iniciar()
    {
        Console.Clear();
        Console.WriteLine("---------------------------------");
        Console.WriteLine("Abrir Reserva");
        Console.WriteLine("---------------------------------");
        ...
        if (amigoReserva.ContemMultaAtiva)
        {
            ...
            if (opcaoPagamento.ToUpper() == "S")
            {
                ...
                emprestimoMulta.FecharEmprestimo();
        ...
        Console.WriteLine($"A reserva \"{reserva.Id}\" foi iniciada e cadastrada com sucesso.");
    ...
    public void Concluir()
    {
        Console.Clear();
        Console.WriteLine("---------------------------------");
        Console.WriteLine("Fechar Reserva");
        Console.WriteLine("---------------------------------");
        ...
        reservaSelecionada.ConcluirReserva();

        System.Console.WriteLine($"A reserva \"{reservaSelecionada.Id}\" foi concluída com sucesso.");
        System.Console.WriteLine("ENTER para continuar...");
        Console.ReadLine();
    }
    ...
    public void VisualizarTodos(bool deveExibirCabecalho)
    {
        if (deveExibirCabecalho)
            System.Console.WriteLine("Visualização de Reservas");
